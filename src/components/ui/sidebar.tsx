  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed top-(--sidebar-top) bottom-(--sidebar-bottom) z-10 hidden h-[calc(100svh-var(--sidebar-top)-var(--sidebar-bottom))] w-(--sidebar-width) transition-[left,right,width] duration-300 ease-in-out md:flex",
            side === "left"
